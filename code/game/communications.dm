 ...
 *   Avoid of sending signals directly from this proc, use spawn(0). Do not use _sleep() here please.
 *     parameters:
 *       signal - see description below. Extract all needed data from the signal before doing _sleep(), spawn() or return!
